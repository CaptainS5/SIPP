...
% before perturbation
target.velocityX(trial.log.targetOnset:trial.log.perturbationOnset, 1) ...
    = Experiment.const.rdk.apertureSpeed*cos(trial.log.rdkApertureDirBefore/180*pi);
target.averageVelX(trial.log.targetOnset:trial.log.perturbationOnset, 1) ...
    = Experiment.const.rdk.apertureSpeed*cos(trial.log.rdkApertureDirBefore/180*pi);
% during perturbation... 
if trial.log.rdkApertureDirBefore==0
target.velocityX(trial.log.perturbationOnset+1:trial.log.targetOffset, 1) ...
...
target.velocityY(trial.log.perturbationOnset+1:trial.log.targetOffset, 1) ...
...
target.averageVelX(trial.log.perturbationOnset+1:trial.log.targetOffset, 1) ...
...
target.internalVelX(trial.log.perturbationOnset+1:trial.log.targetOffset, 1) ...
    = cos(trial.log.rdkInternalDirPerturbation/180*pi); % relative internalDirPerturbation
target.internalVelY(trial.log.perturbationOnset+1:trial.log.targetOffset, 1) ...
