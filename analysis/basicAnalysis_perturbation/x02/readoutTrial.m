...
trial.log.perturbationOffset = find(eyeData.timeStamp==eventLog.perturbationOff(currentTrial, 1)); % rdk onset
trial.log.targetOffset = find(eyeData.timeStamp==eventLog.rdkOff(currentTrial, 1)); % rdk offset
trial.log.respond = find(eyeData.timeStamp==eventLog.respond(currentTrial, 1)); % rdk offset
