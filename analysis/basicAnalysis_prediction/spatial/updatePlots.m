...
occlusionOnset = trial.log.occlusionOnset; % this may have to be changed depending on terminology
occlusionOffset = trial.log.occlusionOffset;
...
plot(trial.eyeX_filt(stimOnset+1:occlusionOnset), trial.eyeY_filt(stimOnset+1:occlusionOnset), 'b-');
plot(trial.eyeX_filt(occlusionOnset+1:occlusionOffset), trial.eyeY_filt(occlusionOnset+1:occlusionOffset), 'b--');
plot(trial.eyeX_filt(occlusionOffset+1:stimOffset), trial.eyeY_filt(occlusionOffset+1:stimOffset), 'b-');
...
line([trial.log.occlusionOnset trial.log.occlusionOnset], [minPosX maxPosX],'Color','r','LineStyle','--');
line([trial.log.occlusionOffset trial.log.occlusionOffset], [minPosX maxPosX],'Color','r','LineStyle','--');
...
line([trial.log.occlusionOnset trial.log.occlusionOnset], [minVel maxVel],'Color','r','LineStyle','--');
line([trial.log.occlusionOffset trial.log.occlusionOffset], [minVel maxVel],'Color','r','LineStyle','--');
