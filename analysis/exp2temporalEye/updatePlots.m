...
plot(trial.eyeX_filt(trial.pursuit.summary.openLoopEnd), trial.eyeY_filt(trial.pursuit.summary.openLoopEnd), 'go');
...
% if trial.log.eyeCondition==1 % pursuit trials
    ...
    line([trial.pursuit.summary.openLoopEnd trial.pursuit.summary.openLoopEnd], [minPosX maxPosX],'Color','b','LineStyle','--');
% end
...
% if trial.log.eyeCondition==1 % pursuit trials
    ...
    line([trial.pursuit.summary.openLoopEnd trial.pursuit.summary.openLoopEnd], [minVel maxVel],'Color','b','LineStyle','--');
...
% if trial.log.eyeCondition==1 % pursuit trials
    ...
    line([trial.pursuit.summary.openLoopEnd trial.pursuit.summary.openLoopEnd], [minAcc maxAcc],'Color','b','LineStyle','--');
% end
line([startFrame endFrame], [0 0],'Color','k','LineStyle','--')
% if ~isempty(trial.pursuit.onset)
