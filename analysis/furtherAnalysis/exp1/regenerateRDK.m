function dotPos = regenerateRDK(seed, const, screen, control)
% generate the position of each dot in all frames using the records from
% the experiment
...
% set the seed status as used during the experiment
rng(seed);
