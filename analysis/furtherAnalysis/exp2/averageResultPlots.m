        ...
        for subN = 1:size(names, 2)
            ...
            for perturbN = 1:2
                ...
                if varN>=saccadeVarStart
                    saveas(gcf, [saccadeFolder, 'individuals\exp2\sac_', plotVariables{varN}, '_lineplot_phase', num2str(perturbN), '_', names{subN}, '.pdf'])
                elseif varN==1
                    saveas(gcf, [perceptFolder, 'individuals\exp2\', plotVariables{varN}, '_lineplot_phase', num2str(perturbN), '_', names{subN}, '.pdf'])
                else
                    saveas(gcf, [pursuitFolder, 'individuals\exp2\pursuit_', plotVariables{varN}, '_lineplot_phase', num2str(perturbN), '_', names{subN}, '.pdf'])
                end
            end
