...
% names = {'i01'}; 
% apertureSpeed = [8 9 11 12];
% internalCons = [-1, 180, 0];
% internalConNames = {'coh 0', 'dir backward', 'dir forward'}; 
% sampleRate = 1000;

names = {'510'}; 
apertureAngle = [-20 -10 10 20];
shiftDir = [90, -90];
internalCons = [-1, 90, -90];
internalConNames = {'coh 0', 'dir up', 'dir down'}; 
sampleRate = 1000;
...
colorCons = [0 0 0; 1 0 0; 0 0 1]; % for 500/503
