...
currentTrial = 252; % chose trial you want to look at here; default = 1;
% for 500;
...
buttons.next = uicontrol(fig,'string','Next (0) >>','Position',[0,130,100,30],...
    'callback','errorStatus(currentTrial, 1)=0;currentTrial = min(currentTrial+1, Experiment.const.numTrials);analyzeTrial;plotResults;');
