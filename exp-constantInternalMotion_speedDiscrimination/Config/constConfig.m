...
if sbj.block == 1 && sbj.trial==1
    ...
    const.rdk.apertureStandardSpeed = 10;
    ...
    const.rdk.duration = [0.9 1.1]; % display duration of the whole RDK, s; min and max
    const.rdk.apertureSpeed = [8 9 11 12]; % dva per sec; not including the standard speed
