...
%% (2.3)---------------------------------------------------------------
    case 3                                                                  % PHASE 3: response screen if needed
        ...
        if control.rdkApertureSpeed ~= const.rdk.apertureStandardSpeed
            PTBwrite_msg(screen, 'faster or slower?', 'center', 'center', screen.msgfontcolour) % coordinate in relation to screen center
        else
            PTBwrite_msg(screen, 'press right arrow to continue', 'center', 'center', screen.msgfontcolour)
        end
