...
const.makeVideo            = 0;
const.measureLuminance     = 0;                                             % if yes (1), will show full screens of the colour used in the experiment for luminance measure

% 1 = creates a video of a single trial(set any conditions manually in expMain); 0 = off (normal experiment mode)
